...
async def test_add_book_not_authenticated(async_client):
    response = await async_client.post(
        '/book',
        json={'year': 2024, 'title': 'book title', 'author_id': 1},
    )
...
async def test_delete_book_not_authenticated(async_client, book):
...
async def test_patch_book_not_authenticated(async_client, book):
...
async def test_get_book_by_id(async_client, book):
...
async def test_get_book_by_id_not_found(async_client, book):
...
async def test_list_books_filter_name_should_return_5_books(
    async_client, async_session, author
):
    expected_books = 5
    ...
    response = await async_client.get('/book/?name=oo')
...
async def test_list_books_filter_name_should_return_empty(
    ...
    response = await async_client.get('/book/?name=title')
...
async def test_list_books_filter_combined_should_return_5_books(
    async_session, async_client, author
):
    expected_books = 5
    ...
    response = await async_client.get('/book/?year=2000&name=oo')
...
async def test_list_books_pagination_should_return_20_books(
    ...
    response = await async_client.get('/book/?title=2000')
